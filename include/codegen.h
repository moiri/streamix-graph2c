...
void cgen_box_fct_call_end( int );
...
void cgen_box_tt_enable( int, const char* );
void cgen_box_tt_wait( int, const char* );
...
void cgen_connect_tt( int, int, const char*, int, int );
